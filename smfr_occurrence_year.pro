pro smfr_occurrence_year
  ...
  ;file1 = '/Users/ys/Library/Mobile Documents/com~apple~CloudDocs/ys_desktop/Prac/SMFR/MMS/stats_yr/new_list_final/result_allphase_total_7sorted_ge30min_le720min_le1beta.csv' ; MMS
  ...
  bp1 = barplot(year, co_norm, /histogram, xr = [2003, 2023], yr = [0, 2000], position = [0.2, 0.15, 0.93, 0.9], fill_color = 'gray', xtitle = '[Wind] Year', ytitle = 'Number of SMFR Events [Counts/year]', font_size = 17, xtickinterval = 3, xminor = 2, yminor = 4, xticklen = 0.02, yticklen = 0.02, xtickdir = 1, ytickdir = 1, /current)
  ;=====MMS====
  ...
  stop
  ;bp1.save, '/Users/ys/Library/Mobile Documents/com~apple~CloudDocs/ys_desktop/Prac/SMFR/MMS/stats_yr/new_list_final/plot/figure5_a.png'
