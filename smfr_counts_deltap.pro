pro smfr_counts_deltaP

  ;======= [MMS] hist delta_pressure vs # of evnets [statistics] =================
  file = '/Users/ys/Library/Mobile Documents/com~apple~CloudDocs/ys_desktop/Prac/SMFR/MMS/stats_yr/new_list_final/result_allphase_total_9sorted_ge30min_le720min_le1beta_deltaP_loc.csv'
  ...
  bp1 = barplot(loc, hist, /histogram, xrange = [-3, 3], yrange = [0, 10], pos = [0.2, 0.17, 0.9, 0.9], fill_color = 'gray', xtitle = '[MMS] $\Delta$p [nPa]', ytitle = 'Number of SMFR Events', font_size = 17, xtickinterval = 1, xminor = 4, ytickinterval = 10, yminor = 4, xticklen = 0.02, yticklen = 0.02, xtickdir = 1, ytickdir = 1, /current)
    t = text(0.24, 0.80, '(a)', 'black', font_size = 23, target = bp1)

  bp1.save, '/Users/ys/Library/Mobile Documents/com~apple~CloudDocs/ys_desktop/Prac/SMFR/MMS/stats_yr/new_list_final/plot/figure8_a.png'
  stop
